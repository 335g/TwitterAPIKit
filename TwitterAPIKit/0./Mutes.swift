...
extension Twitter {
    public class Mutes {
        ...
        ///
        public class Ids: Mutes, APIKit.Request {
            public typealias Response = Dictionary<String, AnyObject>
            public typealias Method = Twitter.Mutes.Get
            
            public init(
                _ client: OAuthClient,
                cursor: Int64 = -1
                ){
                    super.init(client, parameters: ["cursor": cursor as? AnyObject])
            }
        ...
        ///
        public class List: Mutes, APIKit.Request {
            public typealias Response = Dictionary<String, AnyObject>
            public typealias Method = Twitter.Mutes.Get
        ...
        ///
        public class Create: Mutes, APIKit.Request {
            public typealias Response = Dictionary<String, AnyObject>
            public typealias Method = Twitter.Mutes.Post
        ...
        ///
        public class Destroy: Mutes, APIKit.Request {
            public typealias Response = Dictionary<String, AnyObject>
            public typealias Method = Twitter.Mutes.Post
